...
const ChevronDown = (props: React.SVGAttributes<HTMLOrSVGElement>)=> {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" {...props}
